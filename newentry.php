...
<h1>Create New Entry</h1>
    ...
    <select name="category" required style="border-radius: 12px;" >
            <option value="family">Family</option>
            <option value="friend">Friend</option>
    		<option value="office">Office</option>
    </select>
        <br><br>	
	<textarea name="newentry" maxlength="800" rows="10" cols="70" style="margin-left: 10px;"></textarea>
	<br>	<br>
	<button type="submit" name="add"  style="border-radius: 12px; color: #fff; padding: 5px;">Add Entry</button>
    </form>
	</div>
</body>
</html>
